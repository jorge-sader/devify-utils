...
// Marshal serializes the given data to YAML format.
...
// Unmarshal parses YAML data into the given destination struct.
...
// ReadFile reads a YAML file from the given path and unmarshals it into the destination struct.
...
// WriteFile marshals the given data to YAML and writes it to the specified file path.
// It validates the directory path and ensures the file has a valid YAML extension.
